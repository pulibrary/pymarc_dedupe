...
class GoldRush:
  ...
  def as_gold_rush(self):
    return self.title() + self.publication_year() + self.pagination() + self.edition() + self.publisher_name() + self.marc_record.type_of() + self.title_part() + self.title_number()
  ...
  def publisher_name(self):
    ...
    publisher_name = publisher_name.translate(str.maketrans(self.title_translation_dictionary()))
  ...
  def normalize_title(self, some_string):
    ...
    some_string = some_string.translate(str.maketrans(self.title_translation_dictionary()))
    return some_string
