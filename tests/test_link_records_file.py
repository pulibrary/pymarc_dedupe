...
def test_importing_xml_file(example_dictionary):
    os.remove("tests/fixtures/alma_marc_records_short.csv")
    link_records = LinkRecordsFile("tests/fixtures/alma_marc_records_short.xml")
...
def test_when_a_csv_already_exists(example_dictionary):
    LinkRecordsFile("tests/fixtures/alma_marc_records_short.xml")
    link_records = LinkRecordsFile("tests/fixtures/alma_marc_records_short.xml")
    data_from_method = link_records.read_data()
    assert data_from_method == example_dictionary
