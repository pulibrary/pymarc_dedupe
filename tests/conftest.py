...
def fixture_example_dictionary():
    return {
        "tests/alma_marc_records_short.csv0": {
        ...
        "tests/alma_marc_records_short.csv1": {
        ...
        "tests/alma_marc_records_short.csv2": {
        ...
        "tests/alma_marc_records_short.csv3": {
        ...
        "tests/alma_marc_records_short.csv4": {
        ...
        "tests/alma_marc_records_short.csv5": {
        ...
        "tests/alma_marc_records_short.csv6": {
        ...
        "tests/alma_marc_records_short.csv7": {
        ...
        "tests/alma_marc_records_short.csv8": {
        ...
        "tests/alma_marc_records_short.csv9": {
        ...
        "tests/alma_marc_records_short.csv10": {
